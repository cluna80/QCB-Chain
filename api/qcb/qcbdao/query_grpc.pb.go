...
const (
	Query_Params_FullMethodName      = "/qcb.qcbdao.Query/Params"
	Query_Proposal_FullMethodName    = "/qcb.qcbdao.Query/Proposal"
	Query_ProposalAll_FullMethodName = "/qcb.qcbdao.Query/ProposalAll"
)
