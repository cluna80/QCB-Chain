...
const (
	Query_Params_FullMethodName  = "/qcb.qcbeconomy.Query/Params"
	Query_Task_FullMethodName    = "/qcb.qcbeconomy.Query/Task"
	Query_TaskAll_FullMethodName = "/qcb.qcbeconomy.Query/TaskAll"
)
