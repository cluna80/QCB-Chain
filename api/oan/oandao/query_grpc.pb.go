...
const (
	Query_Params_FullMethodName      = "/oan.oandao.Query/Params"
	Query_Proposal_FullMethodName    = "/oan.oandao.Query/Proposal"
	Query_ProposalAll_FullMethodName = "/oan.oandao.Query/ProposalAll"
)
