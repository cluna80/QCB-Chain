...
const (
	Query_Params_FullMethodName  = "/oan.oaneconomy.Query/Params"
	Query_Task_FullMethodName    = "/oan.oaneconomy.Query/Task"
	Query_TaskAll_FullMethodName = "/oan.oaneconomy.Query/TaskAll"
)
