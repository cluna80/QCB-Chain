...
import (
	...
	"qcb/testutil/sample"
	qcbdaosimulation "qcb/x/qcbdao/simulation"
	"qcb/x/qcbdao/types"
)

// avoid unused import issue
var (
	_ = qcbdaosimulation.FindAccount
	_ = rand.Rand{}
	_ = sample.AccAddress
	_ = sdk.AccAddress{}
...
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	...
	qcbdaoGenesis := types.GenesisState{
		Params: types.DefaultParams(),
		// this line is used by starport scaffolding # simapp/module/genesisState
	}
	simState.GenState[types.ModuleName] = simState.Cdc.MustMarshalJSON(&qcbdaoGenesis)
}
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		qcbdaosimulation.SimulateMsgSubmitProposal(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		qcbdaosimulation.SimulateMsgVoteProposal(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		qcbdaosimulation.SimulateMsgExecuteProposal(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		qcbdaosimulation.SimulateMsgVetoProposal(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		qcbdaosimulation.SimulateMsgDelegateVote(am.accountKeeper, am.bankKeeper, am.keeper),
	))
