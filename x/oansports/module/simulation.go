...
import (
	...
	"oan/testutil/sample"
	oansportssimulation "oan/x/oansports/simulation"
	"oan/x/oansports/types"
)

// avoid unused import issue
var (
	_ = oansportssimulation.FindAccount
	_ = rand.Rand{}
	_ = sample.AccAddress
	_ = sdk.AccAddress{}
...
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	...
	oansportsGenesis := types.GenesisState{
		Params: types.DefaultParams(),
		// this line is used by starport scaffolding # simapp/module/genesisState
	}
	simState.GenState[types.ModuleName] = simState.Cdc.MustMarshalJSON(&oansportsGenesis)
}
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		oansportssimulation.SimulateMsgRegisterAthlete(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		oansportssimulation.SimulateMsgCreateStadium(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		oansportssimulation.SimulateMsgScheduleMatch(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		oansportssimulation.SimulateMsgRecordMatchResult(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		oansportssimulation.SimulateMsgPlacePrediction(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		oansportssimulation.SimulateMsgClaimPredictionReward(am.accountKeeper, am.bankKeeper, am.keeper),
	))
