...
import (
	...
	"qcb/testutil/sample"
	qcbeconomysimulation "qcb/x/qcbeconomy/simulation"
	"qcb/x/qcbeconomy/types"
)

// avoid unused import issue
var (
	_ = qcbeconomysimulation.FindAccount
	_ = rand.Rand{}
	_ = sample.AccAddress
	_ = sdk.AccAddress{}
...
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	...
	qcbeconomyGenesis := types.GenesisState{
		Params: types.DefaultParams(),
		// this line is used by starport scaffolding # simapp/module/genesisState
	}
	simState.GenState[types.ModuleName] = simState.Cdc.MustMarshalJSON(&qcbeconomyGenesis)
}
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgCreateTask,
		qcbeconomysimulation.SimulateMsgCreateTask(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		qcbeconomysimulation.SimulateMsgCompleteTask(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgAcceptTask,
		qcbeconomysimulation.SimulateMsgAcceptTask(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		qcbeconomysimulation.SimulateMsgDisputeTask(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgClaimUbi,
		qcbeconomysimulation.SimulateMsgClaimUbi(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		qcbeconomysimulation.SimulateMsgStakeTokens(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		qcbeconomysimulation.SimulateMsgDistributeRewards(am.accountKeeper, am.bankKeeper, am.keeper),
	))
