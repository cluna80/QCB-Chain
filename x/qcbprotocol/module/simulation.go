...
import (
	...
	"qcb/testutil/sample"
	qcbprotocolsimulation "qcb/x/qcbprotocol/simulation"
	"qcb/x/qcbprotocol/types"
)

// avoid unused import issue
var (
	_ = qcbprotocolsimulation.FindAccount
	_ = rand.Rand{}
	_ = sample.AccAddress
	_ = sdk.AccAddress{}
...
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	...
	qcbprotocolGenesis := types.GenesisState{
		Params: types.DefaultParams(),
		// this line is used by starport scaffolding # simapp/module/genesisState
	}
	simState.GenState[types.ModuleName] = simState.Cdc.MustMarshalJSON(&qcbprotocolGenesis)
}
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		qcbprotocolsimulation.SimulateMsgSetAddressTier(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		qcbprotocolsimulation.SimulateMsgUpdateLaunchPhase(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		qcbprotocolsimulation.SimulateMsgUpdateProtocolParams(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		qcbprotocolsimulation.SimulateMsgExemptAddress(am.accountKeeper, am.bankKeeper, am.keeper),
	))
