...
import (
	...
	"oan/testutil/sample"
	oanwalletprotosimulation "oan/x/oanwalletproto/simulation"
	"oan/x/oanwalletproto/types"
)

// avoid unused import issue
var (
	_ = oanwalletprotosimulation.FindAccount
	_ = rand.Rand{}
	_ = sample.AccAddress
	_ = sdk.AccAddress{}
...
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	...
	oanwalletprotoGenesis := types.GenesisState{
		Params: types.DefaultParams(),
		// this line is used by starport scaffolding # simapp/module/genesisState
	}
	simState.GenState[types.ModuleName] = simState.Cdc.MustMarshalJSON(&oanwalletprotoGenesis)
}
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		oanwalletprotosimulation.SimulateMsgRegisterWalletProfile(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		oanwalletprotosimulation.SimulateMsgSetEncryptionKey(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgSetPqKey,
		oanwalletprotosimulation.SimulateMsgSetPqKey(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		oanwalletprotosimulation.SimulateMsgUpdateWalletProfile(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		oanwalletprotosimulation.SimulateMsgSetWalletPermissions(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgLockWallet,
		oanwalletprotosimulation.SimulateMsgLockWallet(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		oanwalletprotosimulation.SimulateMsgUnlockWallet(am.accountKeeper, am.bankKeeper, am.keeper),
	))
