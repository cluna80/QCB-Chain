...
import (
	...
	"oan/testutil/sample"
	oanguardiansimulation "oan/x/oanguardian/simulation"
	"oan/x/oanguardian/types"
)

// avoid unused import issue
var (
	_ = oanguardiansimulation.FindAccount
	_ = rand.Rand{}
	_ = sample.AccAddress
	_ = sdk.AccAddress{}
...
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	...
	oanguardianGenesis := types.GenesisState{
		Params: types.DefaultParams(),
		// this line is used by starport scaffolding # simapp/module/genesisState
	}
	simState.GenState[types.ModuleName] = simState.Cdc.MustMarshalJSON(&oanguardianGenesis)
}
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		oanguardiansimulation.SimulateMsgAddGuardian(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		oanguardiansimulation.SimulateMsgRemoveGuardian(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		oanguardiansimulation.SimulateMsgGuardianVeto(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		oanguardiansimulation.SimulateMsgSetAiLimits(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		oanguardiansimulation.SimulateMsgEmergencyPause(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgLiftPause,
		oanguardiansimulation.SimulateMsgLiftPause(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		oanguardiansimulation.SimulateMsgApproveModel(am.accountKeeper, am.bankKeeper, am.keeper),
	))
